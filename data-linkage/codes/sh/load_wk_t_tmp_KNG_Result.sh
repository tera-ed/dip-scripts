...
IGNORE 1 LINES
  (
  @kng_in_seq,@kng_in_crpnam,@kng_in_keiflg,@office_id,@result_flg,@detail_lvl,@detail_content
  )
SET
  kng_in_seq = nullif(@kng_in_seq, ''),
  kng_in_crpnam = nullif(@kng_in_crpnam, ''),
  kng_in_keiflg = nullif(@kng_in_keiflg, ''),
