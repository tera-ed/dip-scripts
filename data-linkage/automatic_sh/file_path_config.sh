...
PYTHON_SOURCE_DIR_PATH="/home/dip-sysinfo/crm_src_cfl_testing"
PYTHON_SOURCE_TMP_DIR_PATH=${PYTHON_SOURCE_DIR_PATH}"/files/output/RivalMedia/python2"
PYTHON_SOURCE_OK_PATH=${PYTHON_SOURCE_TMP_DIR_PATH}"/OK"
...
PROCESSING5="GET_TABAITAI_PROCESSING"
